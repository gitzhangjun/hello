package com.shop.course.user.controller;

import com.alibaba.nacos.common.util.Md5Utils;
import com.shop.course.util.IDWorker;
import com.shop.course.util.Result;
import com.shop.course.util.ResultUtil;
import com.shop.course.user.entity.User;
import com.shop.course.user.service.UserService;
...
public class UserController {
    ...
    private IDWorker idGenerate = new IDWorker(0, 1);
    /**
     * 通过主键查询单条数据
     *
     * @param id 主键
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType = "query", name = "email",
                    value = "邮箱", required = false,defaultValue = "def@def.com"),
    ...
    public Result<User> regUser(@Valid @Size(min = 3 , max = 20 ,message = "账号长度需在3-20范围了") String account ,
        ...
        newUser.setUserId(idGenerate.nextId());
    ...
    public Result<User> changePasswd(@Valid @NotNull(message = "输入信息有误") Long id ,
    ...
    public Result<User> delete(@Valid @NotNull(message = "输入信息有误") Long id ) {
